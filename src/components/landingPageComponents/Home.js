    ...
    return (
        <div>
            <div className="bg-primary_2 p-3 font-comfortaa sm:p-6 lg:p-0 pb-8">
                <div className="sm:flex pb-10 lg:grid lg:grid-cols-3" data-aos="fade-up">
                    <div className="pr-5 sm:min-w-72 lg:p-6 lg:py-24 2xl:py-44 2xl:pl-16 screen3xl:py-60 screen3xl:pl-24">
                        ...
                        <div className="hidden w-full flex items-center h-24 lg:flex">
                            <button
                                ...
                                <a className="pl-2 xl:text-2xl screen3xl:text-4xl" href={`${process.env.PUBLIC_URL}/FRONT END CV.pdf`} download="FRONT END CV.pdf">
                                    Download CV
                                </a>
                            </button>
                        </div>
                ...
                <div className="w-full flex justify-center items-center h-16 lg:hidden">
                    <button
                        ...
                        <a className="pl-2" href={`${process.env.PUBLIC_URL}/FRONT END CV.pdf`} download="FRONT END CV.pdf">
                            Download CV
                        </a>
                    </button>
                </div>
