...
export default function Header() {
    ...
    return(
        <div className="font-comfortaa bg-secondary-100 text-primary_1 sm:bg-primary_1 sm:text-black" id="menu">
            ...
            <div className="flex items-center justify-between flex-1 px-2 py-3 text-xs font-thin sm:px-0 sm:py-0"> {/* Added flex-1 to make the container take up the remaining space */}
                <div>
